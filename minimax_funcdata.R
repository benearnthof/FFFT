...
crack_n_intervals = 50
crack_intervalsize = 50
crack_fleet = purrr::rdunif(100, 1, 1)
crack_proportion = c(1, 1, 0)
crack_means = c(0.16, 0.97060, 2.4)
crack_sds = c(0.08, 0.05444, 0.08)
crack_mins = c(0, 0, 0)
